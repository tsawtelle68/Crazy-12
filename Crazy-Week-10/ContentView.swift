...
class GameScene:SKScene
{
    override func sceneDidLoad()
    {
        ...
        let dummy = SKTexture(imageNamed: "Deck-Empty-Space")
        ...
        let dummyArray:Array<SKTexture> = [dummy]
        ...
        let dummyPile:SKSpriteNode = SKSpriteNode(imageNamed: "Deck-Empty-Space");
        ...
        dummyPile.position = CGPoint(x: 215, y: 715);
        sparePile1.position = CGPoint(x: 260, y: 720);
        sparePile2.position = CGPoint(x: 305, y: 720);
        sparePile3.position = CGPoint(x: 350, y: 720);
        playPile1.position = CGPoint(x: 60, y: 630);
        playPile2.position = CGPoint(x: 105, y: 630);
        playPile3.position = CGPoint(x: 150, y: 630);
        playPile4.position = CGPoint(x: 195, y: 630);
        playPile5.position = CGPoint(x: 240, y: 630);
        playPile6.position = CGPoint(x: 285, y: 630);
        playPile7.position = CGPoint(x: 330, y: 630);
        ...
        dummyPile.xScale = cardScaleX;
        dummyPile.yScale = cardScaleY;
        ...
        dummyPile.run(SKAction.repeatForever(SKAction.animate(with: dummyArray, timePerFrame: 3.0)))
